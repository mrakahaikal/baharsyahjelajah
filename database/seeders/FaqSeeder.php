    ...
    public function run(): void
    {
        $faqs = [
            ...
            [
                ...
                'answer' => ['id' => 'Ya. Harga dasar sewa sudah termasuk kendaraan ber-AC, sopir berpengalaman, dan bahan bakar minyak untuk perjalanan sesuai wilayah yang dipilih.', 'en' => 'Yes. The base rental rate includes an air-conditioned vehicle, an experienced driver, and fuel for travel within the selected service area.', 'ms' => 'Ya. Kadar sewaan asas termasuk kenderaan berhawa dingin, pemandu berpengalaman, dan bahan api untuk perjalanan dalam kawasan yang dipilih.'],
                'is_active' => true,
            ],
            [
                'category' => 'vehicle',
                ...
                'answer' => ['id' => 'Minimum sewa bergantung pada wilayah: Jakarta, Bandung, dan Yogyakarta mulai 1 hari; Malang minimum 5 hari; serta Bromo/Banyuwangi minimum 6 hari.', 'en' => 'The minimum rental depends on the area: Jakarta, Bandung, and Yogyakarta start from 1 day; Malang requires at least 5 days; and Bromo/Banyuwangi requires at least 6 days.', 'ms' => 'Minimum sewaan bergantung pada kawasan: Jakarta, Bandung, dan Yogyakarta bermula dari 1 hari; Malang minimum 5 hari; dan Bromo/Banyuwangi minimum 6 hari.'],
                'is_active' => true,
            ],
            [
                'category' => 'vehicle',
                'sort_order' => 3,
                'question' => ['id' => 'Biaya apa yang belum termasuk dalam harga sewa?', 'en' => 'Which costs are not included in the rental rate?', 'ms' => 'Kos apakah yang tidak termasuk dalam kadar sewaan?'],
                'answer' => ['id' => 'Harga belum termasuk tol, parkir, tiket wisata, uang makan pengemudi sekitar Rp50.000 per hari, penginapan pengemudi untuk perjalanan menginap, dan biaya penggunaan di luar zona awal.', 'en' => 'The rate excludes tolls, parking, attraction tickets, driver meals of approximately IDR 50,000 per day, driver accommodation for overnight trips, and travel outside the original service area.', 'ms' => 'Kadar tidak termasuk tol, parkir, tiket tarikan, makan pemandu sekitar IDR 50,000 sehari, penginapan pemandu untuk perjalanan bermalam, dan perjalanan di luar kawasan asal.'],
                'is_active' => true,
            ],
        ...
        foreach ($faqs as $faq) {
            ...
            $faq['contexts'] = array_values(array_filter(['home', $context]));
