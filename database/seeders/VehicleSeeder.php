...
class VehicleSeeder extends Seeder
{
    ...
    {
        $vehicles = [
            ['code' => 'innova-reborn-6-seat', 'name' => 'Innova Reborn 6 Seat', 'brand' => 'Toyota', 'model' => 'Innova Reborn', 'category' => VehicleCategory::Car, 'capacity' => 6, 'overtime' => 115000, 'transmission' => 'automatic'],
            ['code' => 'fortuner-pajero', 'name' => 'Fortuner / Pajero', 'brand' => null, 'model' => null, 'category' => VehicleCategory::Car, 'transmission' => 'automatic'],
            ['code' => 'innova-zenix-q', 'name' => 'Innova Zenix Q', 'brand' => 'Toyota', 'model' => 'Innova Zenix Q', 'category' => VehicleCategory::Car, 'overtime' => 115000, 'transmission' => 'automatic'],
            ['code' => 'innova-zenix-g', 'name' => 'Innova Zenix G', 'brand' => 'Toyota', 'model' => 'Innova Zenix G', 'category' => VehicleCategory::Car, 'overtime' => 115000, 'transmission' => 'automatic'],
            ['code' => 'innova-reborn', 'name' => 'Innova Reborn', 'brand' => 'Toyota', 'model' => 'Innova Reborn', 'category' => VehicleCategory::Car, 'overtime' => 115000, 'legacy_model' => 'Innova Reborn', 'transmission' => 'automatic'],
            ['code' => 'new-avanza', 'name' => 'New Avanza', 'brand' => 'Toyota', 'model' => 'Avanza', 'category' => VehicleCategory::Car, 'legacy_model' => 'Avanza', 'transmission' => 'automatic'],
            ['code' => 'brv-xpander', 'name' => 'BR-V / Xpander', 'brand' => null, 'model' => null, 'category' => VehicleCategory::Car, 'transmission' => 'automatic'],
            ['code' => 'avanza-xenia-mobilio', 'name' => 'Avanza / Xenia / Mobilio', 'brand' => null, 'model' => null, 'category' => VehicleCategory::Car, 'transmission' => 'automatic'],
            ['code' => 'brio', 'name' => 'Brio', 'brand' => 'Honda', 'model' => 'Brio', 'category' => VehicleCategory::Car, 'transmission' => 'automatic'],
            ['code' => 'hiace-commuter', 'name' => 'Hiace Commuter', 'brand' => 'Toyota', 'model' => 'HiAce Commuter', 'category' => VehicleCategory::Minibus, 'capacity' => 14, 'capacity_label' => '14+1 seat', 'overtime' => 172500, 'legacy_model' => 'HiAce Commuter', 'transmission' => 'manual'],
            ['code' => 'hiace-premio', 'name' => 'Hiace Premio', 'brand' => 'Toyota', 'model' => 'Hiace Premio', 'category' => VehicleCategory::Minibus, 'overtime' => 172500, 'transmission' => 'manual'],
            ['code' => 'hiace-premio-luxury', 'name' => 'Hiace Premio Luxury', 'brand' => 'Toyota', 'model' => 'Hiace Premio Luxury', 'category' => VehicleCategory::Minibus, 'overtime' => 172500, 'transmission' => 'manual'],
            ['code' => 'elf-19-seat', 'name' => 'Elf 19 Seat', 'brand' => 'Isuzu', 'model' => 'Elf', 'category' => VehicleCategory::Minibus, 'capacity' => 19, 'overtime' => 230000, 'transmission' => 'manual'],
            ['code' => 'elf-premium-19-seat', 'name' => 'Elf Premium 19 Seat', 'brand' => 'Isuzu', 'model' => 'Elf Premium', 'category' => VehicleCategory::Minibus, 'capacity' => 19, 'overtime' => 230000, 'transmission' => 'manual'],
            ['code' => 'new-giga-2025', 'name' => 'New Giga 2025', 'brand' => 'Isuzu', 'model' => 'Giga', 'category' => VehicleCategory::Minibus, 'capacity' => 19, 'year' => 2025, 'overtime' => 230000, 'transmission' => 'manual'],
            ['code' => 'medium-bus-2025', 'name' => 'Medium Bus 2025', 'brand' => null, 'model' => null, 'category' => VehicleCategory::Bus, 'capacity' => 35, 'year' => 2025, 'overtime' => 230000, 'transmission' => 'manual'],
            ['code' => 'big-bus-2025', 'name' => 'Big Bus 2025', 'brand' => null, 'model' => null, 'category' => VehicleCategory::Bus, 'capacity' => 50, 'year' => 2025, 'overtime' => 230000, 'transmission' => 'manual'],
            ['code' => 'big-bus-2017-2018', 'name' => 'Big Bus 2017 / 2018', 'brand' => null, 'model' => null, 'category' => VehicleCategory::Bus, 'capacity' => 59, 'overtime' => 230000, 'transmission' => 'manual'],

            // Arab Saudi Vehicles
            ['code' => 'ford', 'name' => 'Ford (Taurus / Tourneo)', 'brand' => 'Ford', 'model' => 'Taurus / Tourneo', 'category' => VehicleCategory::Car, 'capacity' => 5, 'transmission' => 'automatic'],
            ['code' => 'lexus', 'name' => 'Lexus (ES / RX)', 'brand' => 'Lexus', 'model' => 'ES / RX', 'category' => VehicleCategory::Car, 'capacity' => 4, 'transmission' => 'automatic'],
            ['code' => 'traverse', 'name' => 'Chevrolet Traverse', 'brand' => 'Chevrolet', 'model' => 'Traverse', 'category' => VehicleCategory::Car, 'capacity' => 7, 'transmission' => 'automatic'],
            ['code' => 'gmc', 'name' => 'GMC Yukon / Suburban', 'brand' => 'GMC', 'model' => 'Yukon', 'category' => VehicleCategory::Car, 'capacity' => 7, 'transmission' => 'automatic'],
            ['code' => 'staria', 'name' => 'Hyundai Staria', 'brand' => 'Hyundai', 'model' => 'Staria', 'category' => VehicleCategory::Car, 'capacity' => 9, 'transmission' => 'automatic'],
            ['code' => 'hiace', 'name' => 'Toyota HiAce', 'brand' => 'Toyota', 'model' => 'HiAce', 'category' => VehicleCategory::Minibus, 'capacity' => 14, 'transmission' => 'manual'],
            ['code' => 'coaster', 'name' => 'Toyota Coaster', 'brand' => 'Toyota', 'model' => 'Coaster', 'category' => VehicleCategory::Minibus, 'capacity' => 22, 'transmission' => 'manual'],
            ['code' => 'bus', 'name' => 'Bus Pariwisata (Saudi)', 'brand' => null, 'model' => 'Bus', 'category' => VehicleCategory::Bus, 'capacity' => 45, 'transmission' => 'automatic'],
        ];
