    ...
    public function run(): void
    {
        ...
        foreach ($vehicles as $index => $data) {
            ...
            $data['slug'] = collect($data['name'])
                ...
                ->all();
            $data['description'] = [
                'id' => 'Armada nyaman dengan sopir profesional untuk perjalanan keluarga dan rombongan.',
                'en' => 'A comfortable fleet with a professional driver for family and group journeys.',
                'ms' => 'Armada selesa dengan pemandu profesional untuk perjalanan keluarga dan kumpulan.',
            ];
            $data['features'] = [
                'id' => $data['features'],
                'en' => $data['features'],
