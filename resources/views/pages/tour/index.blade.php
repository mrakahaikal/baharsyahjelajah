...
<x-layouts::app seo-page="tour_index" :title="$seoTitle" :meta-description="$seoDescription" :$canonicalUrl :$alternateUrls breadcrumb-name="tour.index" :breadcrumb-parameters="[$locale]">
