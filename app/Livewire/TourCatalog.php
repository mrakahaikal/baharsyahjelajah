...
class TourCatalog extends Component
{
    ...
    {
        if (! in_array($filter, ['destination', 'category', 'type'], true)) {
            return;
        }
    ...
    {
        $this->reset(['destination', 'category', 'type']);
        $this->resetPage();
    }
    ...
    public function render(): View
    {
        ...
        return view('livewire.tour-catalog', compact('categories', 'locale', 'tours', 'tourTypes'));
    }
