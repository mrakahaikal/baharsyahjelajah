            ...
            ->components([
                Tabs::make('TourFormTabs')
                    ->tabs([
                                                            ...
                                                            Grid::make(2)
                                                                ->schema([
                                                                    TextInput::make('name')
                                                                        ...
                                                                        ->maxLength(255)
                                                                        ->placeholder('Contoh: Pesona Keindahan Raja Ampat')
                                                                    ...
                                                                    TextInput::make('slug')
                                                                        ...
                                                                        ->helperText('Tautan URL halaman tur. Terisi otomatis dari nama tur.')
                        ...
                        Tab::make('Paket Perjalanan & Harga')
                            ->icon('lucide-package')
                            ->schema([
                                                                                ...
                                                                                Grid::make(2)
                                                                                    ->schema([
                                                                                        TextInput::make('name')
                                                                                            ...
                                                                                            ->maxLength(255)
                                                                                            ->placeholder('Contoh: Paket Hemat 4 Hari')
